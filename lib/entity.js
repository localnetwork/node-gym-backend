    ...
    getUserSubscription: async (id) => {
        try {
            ...
            if (hasLifetime) {
                ...
                return { status: 'lifetime', message: "This user has a lifetime subscription."};
            } else {
                const results = await query({
                    sql: `
                ...
                if(results.affectedRows === 0) {
                    return { status: 'no_subscription', message: "This user doesn't have completed subscriptions." };                
                }
                ...
                if(remainingDays > 0) {
                    ...
                    return { status: 'expired', message: "This user's subscription has expired."};
                }
            }
        } catch (error) {
